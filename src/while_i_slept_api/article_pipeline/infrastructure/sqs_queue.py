...
class SqsSummaryJobQueue(SummaryJobQueue):
    ...
    def __init__(self, client: Any, *, queue_name: str | None = None, queue_url: str | None = None) -> None:
        settings = Settings()
        self._client = client
        self._queue_name = queue_name or settings.summary_jobs_queue_name
        self._queue_url: str | None = queue_url or settings.summary_jobs_queue_url
...
class SqsArticleJobQueue(ArticleJobQueue):
    ...
    def __init__(self, client: Any, *, queue_name: str | None = None, queue_url: str | None = None) -> None:
        settings = Settings()
        self._client = client
        self._queue_name = queue_name or settings.article_jobs_queue_name
        self._queue_url: str | None = queue_url or settings.article_jobs_queue_url
